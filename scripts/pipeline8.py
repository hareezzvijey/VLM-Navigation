...
def extract_sidewalk_centerline(
    ...
    slope, intercept = np.polyfit(rows_y, mid_x, 1)
...
def analyse_free_space(
    ...
    # [DI1] Extract centerline and path width BEFORE calling compute_corridor_bounds
    centerline_fn, path_width_px, _ = extract_sidewalk_centerline(
        sidewalk_mask, zone_top, img_h, img_w
    )

    # [P3 + DI1] Corridor bounds: centerline-aligned if possible, else global [P1]
...
class VLMPipeline:
    ...
    def visualize(self, results: dict, save_name: str = "output_v9.png"):
        ...
        # [DI1] Extract centerline and path width for visualisation
